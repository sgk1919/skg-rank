...
可查手机、QQ、微博、快递、身份户籍。使用如下图：

<a href="https://idouyin.io/34" target="_blank"><img src="pic/anjingling.png" alt="暗精灵社工库" border="0"></a>
...
速度很快的一个社工库，支持多种查询方式，姓名查询、身份证号查询、性别模糊查询，可以通过每天签到获取积分。
